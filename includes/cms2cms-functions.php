...
class CmsPluginFunctionsMyBB
{
    ...
    private $jsConfig = '{
        ...
        "wp_feedback"     : "/wordpress.org/support/plugin/cms2cms-mybb-to-bbpress-convertor/reviews",
        "public_host"     : "//www.cms2cms.com",
        "bridge"          : "https://app.cms2cms.com/bridge/download",
        "MyBBExtension" : "https://cms2cms.com/files/MyBB/cms2cmsconnector/com_cms2cmsconnector.zip",
    ...
    {
        $cms2cms_MyBB_access_login = get_option('cms2cms-MyBB-login');
        $cms2cms_MyBB_access_key   = get_option('cms2cms-MyBB-key');

        return array(
            'email'     => $cms2cms_MyBB_access_login,
            'accessKey' => $cms2cms_MyBB_access_key
        );
    }
    ...
    public function isActivated()
    {
        ...
        return ($cms2cms_MyBB_access_key != false);
    }
    ...
    public function getOptions()
    {
        ...
        $login = get_option('cms2cms-MyBB-login');
    ...
    public function saveOptions()
    {
        ...
        if ( $key && $login ) {
            ...
            add_option('cms2cms-MyBB-key', $key);

            delete_option('cms2cms-MyBB-login');
            add_option('cms2cms-MyBB-login', $login);

            delete_option('cms2cms-MyBB-depth');
            add_option('cms2cms-MyBB-depth', $bridge_depth);
    ...
    {
        return $this->__('MyBB', 'cms2cms-MyBB-migration');
    }
    ...
    {
        return $this->__('bbPress', 'cms2cms-bbPress-migration');
    }
    ...
    {
        return sprintf(
            $this->__('CMS2CMS: Automated %s to %s Migration ', 'cms2cms-MyBB-migration'),
    ...
    {
        return sprintf(
            $this->__('%s to %s', 'cms2cms-MyBB-migration'),
            $this->getPluginSourceName(),
            $this->getPluginTargetName()
        );
    }
    ...
    public function logOut()
    {
        if (isset($_REQUEST['_wpnonce'])) {
            ...
            if ($this->verifyFormTempKey($nonce, 'cms2cms_MyBB_logout')
                && $_POST['cms2cms_MyBB_logout'] == 1
            ) {
                $this->clearOptions();
            }
        }        
